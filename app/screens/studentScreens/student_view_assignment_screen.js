...
function StudentViewAssignmentScreen({ navigation ,route}) {
  ...
  const [documenturi, setDocument] = useState("http://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf");
...
if(documenturi=="http://unec.edu.az/application/uploads/2014/12/pdf-sample.pdf") {
  getDocument()
}
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate("File Reader", {
                  uri: "http://d468-2400-adc7-13d-5200-aa5e-5479-6c5f-d4ed.ngrok.io"+documenturi,
                })
              }
            >
