...
function AllSubjectsForAssignmentResultScreen({ navigation }) {
            ...
            <FlatList
              ...
              renderItem={({ item }) => (
                <ClassListItem
                  title={item.title}
                  onPress={() =>
                    navigation.navigate("Assignment Results Screen", {
                      id: item.subject_id,
                      class_id: item.class_id,
                    })
                  }
...
export default AllSubjectsForAssignmentResultScreen;
