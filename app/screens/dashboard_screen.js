...
import { AntDesign, Fontisto, MaterialCommunityIcons, Foundation  } from '@expo/vector-icons'
    ...
    return (
        ...
        <View style={styles.container}>
            <View style={styles.box}>
                <MaterialCommunityIcons name="cash-register" size={35} color="white" />
            ...
            <View style={styles.box}>
                <MaterialCommunityIcons name="source-branch" size={35} color="white" />
                <Text style={styles.text}>Scheme of Study</Text>
            </View>
        </View>
        <View style={styles.container}>
            <View style={styles.box}>
                <MaterialCommunityIcons name="notebook-outline" size={35} color="white" />
        ...
        <View style={styles.container}>
            ...
            <View style={styles.box}>
                <MaterialCommunityIcons name="lightbulb-on-outline" size={35} color="white" />
